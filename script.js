function initengahan(){
  ...
  if(waktuSekarang < 10){ucapan = "Met Pagi, ";} 
  else if(waktuSekarang < 16){ucapan = "Met Siang, ";}
  else if(waktuSekarang < 19){ucapan = "Met Sore, ";}
  else{ucapan = "Met Malam, ";}
  ...
  async function pertanyaan(){var { isConfirmed: prtanya } = await swals.fire({title: nama + ' ' + tanya, text: '' + opstanya, imageUrl: '' + fotostiker6.src, showCancelButton: true, confirmButtonText: '' + tompositif, cancelButtonText: '' + ditolak,});
    if(prtanya){
